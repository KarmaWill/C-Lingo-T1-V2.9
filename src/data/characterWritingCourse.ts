...
export const WRITING_MODULES: WritingModule[] = [
  {
    id: 'strokes',
    title: 'Stroke Basics',
    subtitle: 'Core strokes & order',
    description: 'Learn the core strokes and stroke order rules.',
    color: '#1D6B63',
    gradient: 'linear-gradient(145deg, #2A9D8F 0%, #1D6B63 100%)',
    itemCount: 8,
    previewChar: '一',
  ...
  },
  {
    id: 'radicals',
    title: 'Radicals',
    subtitle: 'Meaning cues',
    description: 'Recognize common radicals and how they hint at meaning.',
    color: '#0F766E',
    gradient: 'linear-gradient(145deg, #14B8A6 0%, #0F766E 100%)',
    itemCount: 8,
    previewChar: '氵',
